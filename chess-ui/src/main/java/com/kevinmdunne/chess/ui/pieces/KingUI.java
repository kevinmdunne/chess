...
public class KingUI extends Box implements PieceUI,ISelectable{

	private static final URL WHITE_TEXTURE_PATH = SpaceUI.class.getResource("/images/white_king.png");
	private static final URL BLACK_TEXTURE_PATH = SpaceUI.class.getResource("/images/black_king.png");
	
	private Material material;
	private Piece piece;
	
	public KingUI(Piece piece){
