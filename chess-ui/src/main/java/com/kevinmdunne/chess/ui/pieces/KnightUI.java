...
public class KnightUI extends Box implements PieceUI,ISelectable {

	private static final URL WHITE_TEXTURE_PATH = SpaceUI.class.getResource("/images/white_knight.png");
	private static final URL BLACK_TEXTURE_PATH = SpaceUI.class.getResource("/images/black_knight.png");
	
	private Material material;
	private Piece piece;
	
	public KnightUI(Piece piece){
		super(0.03f, 0.08f,0.03f,Primitive.GENERATE_NORMALS + Primitive.GENERATE_TEXTURE_COORDS,null);
