...
public class RookUI extends Box implements PieceUI,ISelectable {
	...
	private static final URL WHITE_TEXTURE_PATH = SpaceUI.class.getResource("/images/white_rook.png");
	private static final URL BLACK_TEXTURE_PATH = SpaceUI.class.getResource("/images/black_rook.png");
	
	private Material material;
	private Piece piece;
	
	public RookUI(Piece piece){
